...
urlpatterns = [
    ...
    path('ui/tickets/board/', views.tickets_board_page, name='tickets_board_page'),
    ...
    path('ui/tickets/<int:ticket_id>/attachments/', views.add_attachment_page, name='add_attachment_page'),
